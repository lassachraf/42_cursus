...
/*   Updated: 2024/06/05 18:07:58 by alassiqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	nb_quotes(void)
{
	...
	if (s_count % 2 != 0)
		return (print_errors("unexpected EOF while looking for matching `\'`"), -1);
	if (d_count % 2 != 0)
		return (print_errors("unexpected EOF while looking for matching `\"`"), -1);
	return (0);
}
...
int	nb_paren(void)
{
	...
	if (l_count > 0 && r_count == 0)
		...
		return (print_errors("syntax error near unexpected token `)'"),-1);
	return (0);
}
